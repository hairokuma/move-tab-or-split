...
export default {
    ...
    activate(state) {
        ...
        atom.commands.add('atom-workspace', {'move-tab-or-split:down': this.moveDown.bind(this)});
        atom.commands.add('atom-workspace', {'move-tab-or-split:left': this.moveLeft.bind(this)});
        atom.commands.add('atom-workspace', {'move-tab-or-split:right': this.moveRight.bind(this)});
        atom.commands.add('atom-workspace', {'move-tab-or-split:up': this.moveUp.bind(this)});
    },
